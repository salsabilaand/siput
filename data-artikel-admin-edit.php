          ...
          <div class="col-md-12">
            <div class="card card-user">
              <div class="card-header">
                <h5 class="card-title">Edit Data Artikel Admin</h5>
              </div>
              <div class="card-body">
                <form action="data-artikel-admin-edit-proses.php" method="POST" enctype="multipart/form-data">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                      <label>Penulis</label>
                        <input type="text" name="username_admin" value="<?php echo $r_tampil_anggota['username_admin']; ?>" class="form-control">
                      </div>
                    </div>
                  </div>
                  <div class="row">
