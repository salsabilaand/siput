                  ...
                  <table class="table">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <div class="tombol-opsi-container"><a href="proses/anggota-hapus.php?id=<?php echo $r_tampil_anggota['id_anggota']; ?>" onclick = "return confirm ('Apakah Anda Yakin Akan Menghapus Data Ini?')" class="tombol" style="color:#ef8157; font-weight:bold">Hapus</a></div>
                      </td>			
                    </tr>		
                    <?php $nomor++; }
                    }
